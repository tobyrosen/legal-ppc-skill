...
3. **Target ROAS.** Used where practice areas or campaign types carry meaningfully different case values. Less commonly used than tCPA.
...
- Phrase and exact match keywords, with broad match tightly isolated in a deliberate test
...
- A Performance Max campaign present with no record of a deliberate decision to run it
...
_This document is the operating lens for family, immigration, and elder law Google Ads accounts on Search and Performance Max. It will frequently diverge from Google's recommendations. That divergence is intentional. Immigration is in scope and carries no vertical-specific doctrine yet._
